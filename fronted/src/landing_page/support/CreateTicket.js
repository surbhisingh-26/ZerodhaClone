            ...
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                     <h4 className=''><i class="fa fa-plus-circle" aria-hidden="true"></i>Account Opening</h4>
                      <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Onine Account Opening</a><br/>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                        <h3 className=''style={{fontSize:"24px"}}><i class="fa-solid fa-user"></i> Account</h3>
                         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Onine Account Opening</a><br/>
                      <a href='' style={{textDecoration:"none", lineHeight:"2.5"}} >Offline Account Opening</a><br/>
                      <a href='' style={{textDecoration:"none", lineHeight:"2.5"}} >Company, Partnership and HUF Account</a><br/>
                      <a href='' style={{textDecoration:"none", lineHeight:"2.5"}} >  Opening</a><br/>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                        <h3 className='' style={{fontSize:"24px"}}> <i class="fa-solid fa-chart-simple"></i>Your Zerodha Account</h3>
                         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Onine Account Opening</a><br/>
                      <a href='' style={{textDecoration:"none", lineHeight:"2.5"}} >Offline Account Opening</a><br/>
                      <a href='' style={{textDecoration:"none", lineHeight:"2.5"}} >Company, Partnership and HUF Account</a><br/>
                      <a href='' style={{textDecoration:"none", lineHeight:"2.5"}} >  Opening</a><br/>
